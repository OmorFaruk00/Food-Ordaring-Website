                                ...
                                <div class="header-icon-style">                                   
                                    ...
                                    <div class="account-curr-lang-wrap f-right" id="user_account">
                                        ...
                                        if (isset($_SESSION['username'])) {                                            
                                            echo '<ul><li class="top-hover"><a href="#" class="text-danger text-capitalize">Hi '.$_SESSION['username'].'<i class="ion-chevron-down text-danger"></i></a><ul><li><a href="#" onclick="profile()">Profile</a></li><li><a href="#">my Order</a></li><li><a href="#" onclick="logout()">Logout</a></li></ul>';
                                        }
                                        ?>
                                    </div>
                                </div>                                        
